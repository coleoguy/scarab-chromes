...
hpdcols <- viridis(2, option = 'D', begin = 0.45)
...
x = 0.0133
points(x, 300, pch = 16, col = hpdcols[1], cex = 1.2)
text(x, 300, pos = 4, labels = 'Fission', cex = 1)
points(x, 285, pch = 16, col = hpdcols[2], cex = 1.2)
text(x, 285, pos = 4, labels = 'Fussion', cex = 1)
# PDF 6x6
